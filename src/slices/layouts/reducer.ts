...
export const initialState: LayoutState = {
  ...
  layoutSemiDarkType: localStorage.getItem("layoutMode") === LAYOUT_MODE_TYPES.DARKMODE ? LAYOUT_SEMI_DARK.DARK : LAYOUT_SEMI_DARK.LIGHT,
  layoutSkintype: LAYOUT_SKIN.DEFAULT,
  layoutModeType: localStorage.getItem("layoutMode") === LAYOUT_MODE_TYPES.DARKMODE ? LAYOUT_MODE_TYPES.DARKMODE : LAYOUT_MODE_TYPES.LIGHTMODE,
  ...
  layoutSidebarColorType: localStorage.getItem("layoutMode") === LAYOUT_MODE_TYPES.DARKMODE ? LEFT_SIDEBAR_COLOR_TYPES.DARK : LEFT_SIDEBAR_COLOR_TYPES.LIGHT,
  layoutTopbarColorType: localStorage.getItem("layoutMode") === LAYOUT_MODE_TYPES.DARKMODE ? LAYOUT_TOPBAR_THEME_TYPES.DARK : LAYOUT_TOPBAR_THEME_TYPES.LIGHT,
};
